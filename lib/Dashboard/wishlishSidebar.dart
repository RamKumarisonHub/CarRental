...
class WishlistSideBar extends StatefulWidget {
  const WishlistSideBar({Key? key}) : super(key: key);

  @override
  State<WishlistSideBar> createState() => _WishlistSideBarState();
}

class _WishlistSideBarState extends State<WishlistSideBar> {
  @override
