...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: getTtile('Notifications', 16, FontWeight.w500, 'Lab Grotesque'),
        leading: InkWell(
            onTap: () {
      ...
      body: Padding(
        ...
        child: ListView(
          ...
          shrinkWrap: true,
          children: [
            getTtile('Today', 14, FontWeight.w500, 'Lab Grotesque'),
            ListView.builder(
                shrinkWrap: true,
                physics: ScrollPhysics(),
                itemCount: 10,
  ...
  Widget notificationwidget(int index) {
    return Slidable(
      key: ValueKey(index),
      endActionPane: ActionPane(motion: ScrollMotion(), children: [
        SlidableAction(
            backgroundColor: black, icon: Icons.delete, onPressed: (context) {})
      ]),
      child: Neumorphic(
        ...
        child: Padding(
          padding:
              const EdgeInsets.only(top: 12, left: 12, right: 12, bottom: 11),
          child: Row(
            children: [
              Container(
                height: 44,
